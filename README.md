...
| 第三部分 | Triton 算子开发。 | [`3.1 Triton 基础`](./docs/03_Triton_Kernels/intro.md) / [`3.2 Triton 进阶`](./docs/03_Triton_Kernels/intro.md) / [`3.3 Triton 项目`](./docs/03_Triton_Kernels/intro.md) / [`06.5 Triton 设计模式`](./docs/03_Triton_Kernels/06_5_Triton_Design_Patterns.md) | ✅ 基本完成，后续会扩展 |
...
| Part 3 | [`3.1 Triton 基础`](./docs/03_Triton_Kernels/intro.md) / [`3.2 Triton 进阶`](./docs/03_Triton_Kernels/intro.md) / [`3.3 Triton 项目`](./docs/03_Triton_Kernels/intro.md) / [`06.5 Triton 设计模式`](./docs/03_Triton_Kernels/06_5_Triton_Design_Patterns.md) | Triton kernel development. | ✅ Complete | [Guide](./03_Triton_Kernels/intro.md) |

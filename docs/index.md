...
| [部分导读：PyTorch 算法实战（9 groups / 33 lessons）](./02_PyTorch_Algorithms/intro.md) | [组内导读：2.1 Basic Operators (5 lessons)](./02_PyTorch_Algorithms/intro.md) / [组内导读：2.2 Model Architecture (4 lessons)](./02_PyTorch_Algorithms/intro.md) / [组内导读：2.3 Fine-Tuning and Training (5 lessons)](./02_PyTorch_Algorithms/intro.md) / [组内导读：2.4 Alignment Methods (3 lessons)](./02_PyTorch_Algorithms/intro.md) / [组内导读：2.5 Backpropagation and VRAM Optimization (3 lessons)](./02_PyTorch_Algorithms/intro.md) / [组内导读：2.6 Core Inference Optimization (3 lessons)](./02_PyTorch_Algorithms/intro.md) / [组内导读：2.7 Advanced Inference Optimization (4 lessons)](./02_PyTorch_Algorithms/intro.md) / [组内导读：2.8 Distributed and Scaling (3 lessons)](./02_PyTorch_Algorithms/intro.md) / [组内导读：2.9 Projects (3 lessons)](./02_PyTorch_Algorithms/intro.md) | PyTorch-level practice for algorithms, models, and inference optimization. | Learners who want to build implementation intuition with familiar tools. | ✅ Complete, continuously refining |

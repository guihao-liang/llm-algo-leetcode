...
| 第三部分 | Triton 算子开发。 | [`3.1 Triton 基础`](./03_Triton_Kernels/intro.md) / [`3.2 Triton 进阶`](./03_Triton_Kernels/intro.md) / [`3.3 Triton 项目`](./03_Triton_Kernels/intro.md) / [`06.5 Triton 设计模式`](./03_Triton_Kernels/06_5_Triton_Design_Patterns.md) | ✅ 完成 |
...
如果你想开始学习，直接从在线站点或左侧部分目录进入即可。环境选择和平台差异统一看 [使用指南](./guide.md)。
...
| Part 3 | [`3.1 Triton 基础`](./03_Triton_Kernels/intro.md) / [`3.2 Triton 进阶`](./03_Triton_Kernels/intro.md) / [`3.3 Triton 项目`](./03_Triton_Kernels/intro.md) / [`06.5 Triton 设计模式`](./03_Triton_Kernels/06_5_Triton_Design_Patterns.md) | Triton kernel development. | ✅ Complete | [Guide](./03_Triton_Kernels/intro.md) |

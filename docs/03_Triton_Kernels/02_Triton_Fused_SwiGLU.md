...
>
> [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/datawhalechina/llm-algo-leetcode/blob/main/03_Triton_Kernels/02_Triton_Fused_SwiGLU.ipynb)
...
**导语：** 这一节先看 Part 1 的相关 Group，再回看 Part 2 的 SwiGLU 任务页，把门控激活和算子融合的认知桥搭起来。
...
**导语：** 如果想对照纯 PyTorch 的实现和参数量推导，可以继续看这页；不影响继续读本节，但会更容易对齐公式。
- [Part 2: 02 SwiGLU Activation](../02_PyTorch_Algorithms/02_SwiGLU_Activation.md)

...
>
> [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/datawhalechina/llm-algo-leetcode/blob/main/03_Triton_Kernels/03_Triton_Fused_RMSNorm.ipynb)
...
**导语：** 这一节先看 Part 1 的相关 Group，再回看 Part 2 的 RMSNorm 任务页，把归一化和访存瓶颈的前置补齐。
...
**导语：** 如果想先把 RMSNorm 的数学定义和 PyTorch 写法过一遍，可以继续看这页；不影响继续读本节，但会更顺。
- [Part 2: 01 RMSNorm Tutorial](../02_PyTorch_Algorithms/01_RMSNorm_Tutorial.md)

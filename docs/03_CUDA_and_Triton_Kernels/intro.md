...
| Task 5 | [3.4 CUDA 内核与显存优化](../03_CUDA_and_Triton_Kernels/3_4.md) | 进一步进入 CUDA、通信与系统扩展。 |
...
- [3.4 CUDA 内核与显存优化](../03_CUDA_and_Triton_Kernels/3_4.md)
- [3.5 CUDA 系统扩展](../03_CUDA_and_Triton_Kernels/3_5.md)
